    ...
    <html>
      <head>
        ...
        <style>
          ...
          .номер_талона_в_jira .line{
              line-height: 1pt;
              border-top: 0.5pt solid;
          }
          .номер_талона_в_jira .gray{
            background-color: rgba(0,0,0,0.4);
          }
          .номер_талона_в_jira .part{
              line-height: 13pt;
              font-family: Arial;
              font-weight: bold;
              font-size: 10pt;
      ...
      <body>
        <div class="номер_талона_в_jira">
          <table valign="top" width="100%" style="border-collapse: collapse;"
            border="0" cellspacing="0" cellpadding="9pt 0tp 7.5pt 0pt">
            <tbody>
              <!--  TEST  -->
              <tr>
                <td style="height:30pt; border-bottom: 0.5pt solid black;" colspan="2"
                  align="center" class="hdr">{название талона}</td>
              </tr>
              <xsl:if
                test="
                  *:Диагноз/*:Основной_диагноз/*:Основной_диагноз/*:data/*:Код_по_МКБ_10/*:value/*:value != ''">
                <tr>
                  <td colspan="2" class="line gray"/>
                </tr>
                <tr>
                  <td class="myth" valign="top">
